...
void signUser()async{
  ...
  String result = await FireAuth().signUpUser(fname: _firstnameController.text,
              ...
              children: [
                ...
                InkWell(
                    ...
                    child: Container(
                        child: _isLoading ? const Center(child: CircularProgressIndicator(color: primaryColor,),): const Text(
                          'Register', style: (TextStyle(color: primaryColor)),),
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){navigateTo(context, const login());},
                      child: Container(
